  ...
  return (
    <div className={styles.tabs} role="tablist">
      {subdivisions.map((sub) => {
        ...
        const indicatorHere = dropIndicator && dropIndicator.id === sub.id ? dropIndicator.side : null
        const wrapperClass = indicatorHere ? `${styles.tabWrapper} ${indicatorHere === 'left' ? styles.dropLeft : styles.dropRight}` : styles.tabWrapper
